...
def capture_label_xpath(request):  
    ...
    print(pull_ui_object_new_label(data['actual_xpath']))
...
def capture_xpath(request):
    ...
    print("ui object value:")
    print(pull_ui_object_new(data['actual_xpath']))
...
def automatic_fetch(request):
    ...
    d=[]
    with open('C:/Users/Ei12974/Downloads/integrate_extension_with_lowcode_app/Lowcode-app-master/backend/inputData.csv', 'r') as csv_file:
